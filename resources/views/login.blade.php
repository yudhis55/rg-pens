...
<head>
    ...
    <meta charset="utf-8" />
    <title>Sign In | RG-PENS</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('assets/images/pens/logo-pens.png') }}">
                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index.html" class="d-block">
                                                    <img src="{{ asset('assets/images/pens/logo-pens.png') }}" alt="" height="80">
                                                </a>
                                            </div>
                                            {{-- <div class="mt-auto">
                                                <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Masuk untuk melanjutkan ke dashboard RG</p>
                                        </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">PENS Research Group - 2025
                                                {{-- <a href="auth-signup-cover.html" class="fw-semibold text-primary text-decoration-underline"> Signup</a> --}}
                                            </p>
                                        </div>
                                    </div>
                                </div>
